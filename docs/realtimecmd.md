...
This list reflects realtime commands used by the WebUI (`realCommandsTable.js` per target, StatusCNC, OverridesCNC, SpindleCNC, preferences).
...
-   0x8B : MPG enable toggle #MPG-ENABLE-TOGGLE#
...
{ name: "#MPG-ENABLE-TOGGLE#", value: "\x8B" },
{ name: "#FO100#", value: "\x90" },
{ name: "#FO+10#", value: "\x91" },
{ name: "#FO-10#", value: "\x92" },
{ name: "#FO+1#", value: "\x93" },
