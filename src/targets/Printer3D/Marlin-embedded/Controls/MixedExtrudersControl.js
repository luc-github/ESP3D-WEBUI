        ...
        return (
          <div class="mixed-extruder-control m-1">
            <div
              ...
              style={"background-color:" + mixedExtrudersWeight[index].color}
            >
              <div class="label">{String.fromCharCode(65 + index)}</div>
            </div>
            {mixedExtrudersWeight.length > 2 && (
              <ButtonImg
                ...
                onclick={(e) => {
                  const nblocked = mixedExtrudersWeight.reduce((acc, value) => {
                    return value.locked ? acc + 1 : acc;
                  }, 0);
                  if (
                    mixedExtrudersWeight.length - 2 <= nblocked &&
                  ...
                  setLocked(mixedExtrudersWeight[index].locked);
                }}
              />
            )}
            ...
            <Field
              ...
              setValue={(val, update) => {
                ...
                if (
                  ...
                  item.value = mixedExtrudersWeight[index].value;
                } else {
                  if (!update) {
                    const save = mixedExtrudersWeight[index].value;
                    ...
                    if (adjustWeights(index, val)) {
                      if (
                        ...
                        item.value = save;
                        mixedExtrudersWeight[index].value = save;
                      }
                    } else {
                      console.log(
                        "adjustWeights error",
