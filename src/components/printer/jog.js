...
const JogPanel = ({ currentState }) => {
    ...
    return (
    <div class="hide-low">
        <svg width="250"viewBox='0 0 250 250' xmlns="http://www.w3.org/2000/svg" version="1.1">
            <defs>
                ...
                <symbol id="HomeIcon" viewBox="0 0 20 18" pointer-events="none">
                    ...
                    <path class="home" d="M3,18 v-8 l7,-6 l7,6 v8 h-5 v-6 h-4 v6 z" fill="black"></path>
                    <path class="home" d="M0,10 l10-8.5 l10,8.5" stroke-width="1.5" fill="none"></path>
                    <path class="home" d="M15,3 v2.8 l1,.8 v-3.6 z"></path>
                </symbol>
            </defs>
            <g id="HomeAll"  onmouseup={sendHomeCommand} onmousedown={onMouseDown} onmouseout={onOut}>
                <title>{T("P6")}</title>
                <path class="std" d="M10 182.5 h-10 v57.5 h57.5 v-10 a 125,125 0 0,1 -47.5 -47.5 Z" fill="#f0f0f0"></path>
                <use x="3" y="217" width="20" height="18" xlinkHref="#HomeIcon"></use>
            </g>
            <g id="HomeX" onmouseup={sendHomeCommand} onmousedown={onMouseDown} onmouseout={onOut}>
                <title>{T("P7")}</title>
                <path class="std" d="M10 57.50 h-10 v-57.5 h57.5 v10 a 125,125 0 0,0 -47.5 47.5 Z" fill="Khaki"></path>
                <use x="3" y="5" width="20" height="18" xlinkHref="#HomeIcon"></use>
                <text x="25" y="20" class="home"> X </text>
            </g>
            <g id="HomeY" onmouseup={sendHomeCommand} onmousedown={onMouseDown} onmouseout={onOut}>
                <title>{T("P8")}</title>
                <path class="std" d="M230 57.50 h10 v-57.5 h-57.5 v10 a 125,125 0 0,1 47.5 47.5 z" fill="SteelBlue"></path>
                <use x="217" y="5" width="20" height="18" xlinkHref="#HomeIcon"></use>
                <text x="202" y="20" class="home"> Y </text>
            </g>
            <g id="HomeZ" onmouseup={sendHomeCommand} onmousedown={onMouseDown} onmouseout={onOut}>
                <title>{T("P9")}</title>
                <path class="std" d="M230 182.5 h10 v57.5 h-57.5 v-10 a 125,125 0 0,0 47.5 -47.5 z" fill="DarkSeaGreen"></path>
                <use x="217" y="217" width="20" height="18" xlinkHref="#HomeIcon"></use>
                <text x="202" y="232" class="home" id="homeZlabel"> Z </text>
            </g>
            <g id="Jog100" fill="#c0c0c0" class="std">
                <g id="Y+100" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-60 -67.07 L-75.93,-83 A112.5,112.5 0 0,1 75,-83 L60,-67.07 A90,90 0 0,0 -60.00,-67.07 z"></path>
                </g>
                <g id="X+100" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog}  transform="translate(120 120)">
                    <path class="std" d="M67.07,-60 L83,-75.93 A112.5,112.5 0 0,1 83,75.93 L67.07,60 A90,90 0 0,0 67.07,-60"></path>
                </g>
                <g id="Y-100" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-60,67.07 L-75.93,83 A112.5,112.5 0 0,0 75,83 L60,67.07 A90,90 0 0,1 -60.00,67.07 z"></path>
                </g>
                <g id="X-100" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-67.07,-60 L-83,-75.93 A112.5,112.5 0 0,0 -83,75.93 L-67.07,60 A90,90 0 0,1 -67.07,-60 z"></path>
                </g>
            </g>
            <g id="Jog10" fill="#d0d0d0">
                <g id="Y+10" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-44.06 -51.13 L-60,-67.07 A90,90 0 0,1 60,-67 L44.06,-51.13 A67.5,67.5 0 0,0 -44.06,-51.13 z"></path>
                </g>
                <g id="X+10" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M51.13 44.06 L67.07,60 A90,90 0 0,0 67.07,-60 L51.13,-44.06 A67.5,67.5 0 0,1 51.13,44.06 z"></path>
                </g>
                <g id="Y-10" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-44.06 51.13 L-60,67.07 A90,90 0 0,0 60,67 L44.06,51.13 A67.5,67.5 0 0,1 -44.06,51.13 z"></path>
                </g>
                <g id="X-10" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-51.13 44.06 L-67.07,60 A90,90 0 0,1 -67.07,-60 L-51.13,-44.06 A67.5,67.5 0 0,0 -51.13,44.06 z"></path>
                </g>
            </g>
            <g id="Jog1" fill="#e0e0e0">
                <g id="Y+1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-28.09 -35.16 L-44.06,-51.13 A67.5,67.5 0 0,1 44.06,-51.13 L28.09,-35.16 A45,45 0 0,0 -28.09,-35.16 z"></path>
                </g>
                <g id="X+1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M35.16 -28.09 L51.13,-44.06 A67.5,67.05 0 0,1 51.13,44.06 L35.16,28.09 A45,45 0 0,0 35.16,-28.09 z"></path>
                </g>
                <g id="Y-1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-28.09 35.16 L-44.06,51.13 A67.5,67.5 0 0,0 44.06,51.13 L28.09,35.16 A45,45 0 0,1 -28.09,35.16 z"></path>
                </g>
                <g id="X-1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-35.16 -28.09 L-51.13,-44.06 A67.5,67.05 0 0,0 -51.13,44.06 L-35.16,28.09 A45,45 0 0,1 -35.16,-28.09 z"></path>
                </g>
            </g>
            <g id="Jog0_1" fill="#f0f0f0">
                <g id="Y+0_1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-28.09 -35.16 A45,45 0 0,1 29.09,-35.16 L0,-7.07 z"></path>
                </g>
                <g id="X+0_1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog}  transform="translate(120 120)">
                    <path class="std" d="M35.16 -28.09 A45,45 0 0,1 35.16,28.09 L7.07,0 z"></path>
                </g>
                <g id="Y-0_1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog}  transform="translate(120 120)">
                    <path class="std" d="M-28.09 35.16 A45,45 0 0,0 29.09,35.16 L0,7.07 z"></path>
                </g>
                <g id="X-0_1" onmouseup={sendJogCommand} onmouseover={onHoverJog} onmousedown={onMouseDownJog} onmouseout={onOutJog} transform="translate(120 120)">
                    <path class="std" d="M-35.16 -28.09 A45,45 0 0,0 -35.16,28.09 L-7.07,0 z"></path>
                </g>
            </g>
            ...
            <g id="Decoration" pointer-events="none" fill-opacity=".6">
                <path class="std" d="M120,20 l17,17 h-10 v11 h-14 v-11 h-10 z" fill="SteelBlue"></path>
                <path class="std" d="M120,220 l17,-17 h-10 v-11 h-14 v11 h-10 z" fill="SteelBlue"></path>
                <path class="std" d="M20,120 l17,17 v-10 h11 v-14 h-11 v-10 z" fill="Khaki"></path>
                <path class="std" d="M220,120 l-17,-17 v10 h-11 v14 h11 v10 z" fill="Khaki"></path>
                <text class="jog" x="110" y="36" > +Y </text>
                <text class="jog" x="113" y="212"> -Y </text>
                <text class="jog" x="27" y="124"> -X </text>
                <text class="jog" x="196" y="124"> +X </text>
            </g>
